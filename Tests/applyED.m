function applyED(pathToUnprocessedVideo, pathToSaveVideo, pathToSaveImages, imgSize, noOfImages)
% Apply edge detection processing to unprocessed video and save video and
% images
% Inputs:
...
vw = VideoWriter(pathToSaveVideo);
vw.open();
